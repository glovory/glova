...
///
/// The parameters are similar like [MaterialApp], so it won't have any
/// documentation above the variable name.
class OvaApp extends StatelessWidget {
  ...
  /// Distinguished name for [MaterialApp.theme] to avoid mismatch with
  /// OvaTheme
  final ThemeData materialTheme;

  /// Distinguished name for [MaterialApp.darkTheme] to avoid mismatch with
  /// OvaTheme
