...
import 'package:glukutux/src/component/tooltip/triangle_tooltip.dart';

/// A material design tooltip.
///
/// Tooltips provide text labels that help explain the function of a button or
/// other user interface action. Wrap the button in a [TuxTooltip] widget to
...
/// widget to include a [TuxTooltip] in its build.
///
...
class TuxTooltip extends StatefulWidget {
  /// Creates a tooltip.
  ///
  ...
  /// [TuxTooltip.message]. Set this property to true if the app is going to
  ...
  @override
  _TuxTooltipState createState() => _TuxTooltipState();
...
class _TuxTooltipState extends State<TuxTooltip> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (theme.brightness == Brightness.dark) {
      ...
      defaultDecoration = BoxDecoration(
        color: TuxColor.info.withOpacity(0.9),
          ...
          child: FadeTransition(
            ...
            child: Column(
              children: <Widget>[
                CustomPaint(
                  size: Size(15.0, 10),
                  painter: TrianglePainter(isDown: false, color: TuxColor.info),
                ),
                ConstrainedBox(
